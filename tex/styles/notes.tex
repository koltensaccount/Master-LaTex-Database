...
\DeclareCaptionFont{noteslabelfont}{\NotesFontHeader\color{Primary}}
\DeclareCaptionFont{notescaptionfont}{\NotesFontCaption}

\captionsetup[figure]{%
  labelfont=noteslabelfont,%
  textfont=notescaptionfont,%
  name=FIGURE,%
  labelsep=space,%
    ...
    \begin{minipage}{\dimexpr\paperwidth - 2in\relax} 
      ...
      \begin{tikzpicture}[baseline=(chapnum.base)]
        ...
        \node[font=\NotesFontTitle,text=Primary,
              ...
              align=left,text width=\dimexpr(\paperwidth - 2in) - 4cm\relax] (title) {#2};
      \end{tikzpicture}
    \end{minipage}
  }%
  \markboth{#2}{#2}%
